...
def infer_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default=abspath + 'asu/assets/models/v3_det.onnx')
    ...
    parser.add_argument("--rec_model_dir", type=str, default=abspath + 'asu/assets/models/v4_rec.onnx')
    ...
    parser.add_argument(
        "--rec_char_dict_path",
        type=str,
        default=abspath + 'asu/assets/models/ppocr_keys_v1.txt')

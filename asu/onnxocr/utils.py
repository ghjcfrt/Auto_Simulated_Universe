...
from asu.core.common.paths import models_path
...
def infer_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default=models_path("v3_det.onnx"))
    ...
    parser.add_argument("--rec_model_dir", type=str, default=models_path("v4_rec.onnx"))
    parser.add_argument("--rec_image_inverse", type=str2bool, default=True)
    parser.add_argument("--rec_image_shape", type=str, default="3, 48, 320")
    parser.add_argument("--rec_batch_num", type=int, default=6)
    parser.add_argument("--max_text_length", type=int, default=25)
    parser.add_argument(
        "--rec_char_dict_path", type=str, default=models_path("ppocr_keys_v1.txt")
    )
    ...
    parser.add_argument(
        "--cls_model_dir", type=str, default="./onnxocr/models/ppocrv4/cls/cls.onnx"
    )
